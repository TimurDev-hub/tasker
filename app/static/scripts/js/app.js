	...
	<nav class="header__nav">
		<ul class="header__menu">
			<li class="header__menu-item">
				<a data-route="login" class="header__menu-link header__menu-link--blue">Log in</a>
			</li>
			<li class="header__menu-item">
				<a data-route="registration" class="header__menu-link header__menu-link--yellow">Registration</a>
			</li>
		</ul>
	</nav>
`
const headerUserblock = `
	<div class="header__user-block">
		<ul class="header__menu">
			<li class="header__menu-item">
				<p class="header__menu-link header__menu-link--account">${user.user_name}</p>
			</li>
			<li class="header__menu-item">
	...
	<div class="sections__task">
		<form class="sections__form sections__form--task">
			<fieldset class="sections__field">
				...
				<input name="task_title" type="text" class="sections__text main__inputs" value="${task.task_title}" disabled>
			</fieldset>
			<fieldset class="sections__field">
				<label class="sections__title">Task</label>
				<textarea name="task_text" class="sections__text sections__text--task main__inputs" disabled>${task.task_text}</textarea>
			</fieldset>
			<input name="task_id" type="number" value="${task.id}" hidden>
