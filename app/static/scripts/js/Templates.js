export class Templates {
    ...
    static renderClientHeader(username) {
        return `
			<nav class="header__nav">
				<ul class="header__menu">
					<li class="header__menu-item">
        ...
        return `
			<section class="sections sections--userforms">
				...
				<form id="registrationForm" class="sections__form">
					<fieldset class="sections__field sections__field--userforms">
						<label for="username" class="sections__title">Name</label>
						<input id="username" name="username" autocomplete="off" type="text" class="sections__text sections__text--userforms main__inputs" placeholder="Think of your own name!" maxlength="12" required>
					</fieldset>
					<fieldset class="sections__field">
						<label for="password" class="sections__title">Password</label>
			...
			<section class="sections">
				...
				<form id="taskCreateForm" class="sections__form">
					<fieldset class="sections__field">
						...
						<input id="title" name="task_title" autocomplete="off" type="text" class="sections__text main__inputs" placeholder="Your task\`s title is..." maxlength="16" required>
					</fieldset>
					<fieldset class="sections__field">
						<label for="task" class="sections__title">Task</label>
						<textarea id="task" name="task_text" autocomplete="off" class="sections__text sections__text--task main__inputs" placeholder="Write what you want!" maxlength="64" required></textarea>
					</fieldset>
					<button type="submit" class="sections__submit">Submit</button>
					<span id="formMessageArea"></span>
				</form>
